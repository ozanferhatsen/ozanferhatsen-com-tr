---
layout: base.njk
title: "Yargıtay 6. Hukuk Dairesi E. 2024/1562 K. 2025/1666 | Müteahhitten Bağımsız Bölüm Alan Üçüncü Kişinin İyiniyeti ve Tapusu"
description: "Dava, arsa payı karşılığı inşaat sözleşmesine dayalı tapu iptali, tescil ve ipoteğin kaldırılmasıdır. Yargıtay, bilirkişi raporları ve delil durumunu onaylayarak Bölge Adliye Mahkemesi kararını ONAMIŞTIR."
permalink: "/ictihat/karar/yargitay-6-hukuk-dairesi-2024-1562-e-2025-1666-k/"
...
esas_no: "2024/1562"
karar_no: "2025/1666"
karar_tarihi: "24.04.2025"
year: 2025
summary: "Dava, arsa payı karşılığı inşaat sözleşmesine dayalı tapu iptali, tescil ve ipoteğin kaldırılmasıdır. Yargıtay, bilirkişi raporları ve delil durumunu onaylayarak Bölge Adliye Mahkemesi kararını ONAMIŞTIR."
score: 382.5
legal_terms: ["müteahhitten ev aldım", "TESCIL", "karar 2025/1666", "avans tapu", "YUKLENICI_PAYI_IPOTEK", "şahsi hakkın temliki", "ipotek alacaklısı", "yuklenici_payi_ipotek", "KENTSEL_DONUSUM_6306", "TAPU_IPTAL_TESCIL", "topraktan veya maketten alınan dairede arsa sahibine karşı şahsi hak ve tescil nasıl istenir", "yüklenicinin borcu yüzünden daireme ipotek konulursa haklarım nelerdir", "6. hukuk dairesi", "esas 2024/1562", "ARSA_PAYI_KARSILIGI_INSAAT", "KAT_IRTIFAKI", "arsa sahibi tapumu vermiyor", "müteahhitten daire aldım ama arsa sahibi sözleşmeyi feshedip tapumu iptal ettirebilir mi", "üçüncü kişinin iyiniyeti", "IYINIYET", "TMK 1023"]
topics: ["ARSA_PAYI_KARSILIGI_INSAAT", "YUKLENICI_PAYI_IPOTEK", "KENTSEL_DONUSUM_6306", "TAPU_IPTAL_TESCIL", "KAT_IRTIFAKI", "IYINIYET", "TESCIL"]
...
<section class="section soft precedent-detail">
  <div class="wrap">
    <nav class="breadcrumb" aria-label="Gezinme">
      ...
      <span>6. Hukuk Dairesi E. 2024/1562</span>
    </nav>
    ...
    <div class="precedent-top">
      <aside class="precedent-kunye">
        ...
        <p>
          <strong>Esas No:</strong> 2024/1562<br>
          <strong>Karar No:</strong> 2025/1666<br>
          <strong>Karar Tarihi:</strong> 24.04.2025<br>
      ...
      <aside class="precedent-summary">
        ...
        <p>Dava, arsa payı karşılığı inşaat sözleşmesine dayalı tapu iptali, tescil ve ipoteğin kaldırılmasıdır. Yargıtay, bilirkişi raporları ve delil durumunu onaylayarak Bölge Adliye Mahkemesi kararını ONAMIŞTIR.</p>
    ...
    <article class="decision-text precedent-official-text" aria-label="Yargıtay İlamı Resmî Metni">
      ...
      <div style="white-space: pre-wrap; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14.5px; line-height: 1.7; color: #1c1b18; background: #fff; padding: 24px; border: 1px solid #e8e5e0; border-radius: 6px;">6. Hukuk Dairesi 2024/1562 E. , 2025/1666 K.

"İçtihat Metni"MAHKEMESİ : Kayseri Bölge Adliye Mahkemesi 4. Hukuk Dairesi
SAYISI : 2024/61 E., 2024/376 K.
BİRLEŞEN DAVA YOZGAT 2. ASLİYE HUKUK MAHKEMESİ 2023/711 ESAS
İLK DERECE MAHKEMESİ : Yozgat 2. Asliye Hukuk Mahkemesi
SAYISI : 2023/230 E., 2023/655 K. 

Bölge Adliye Mahkemesi kararı birleşen davada davalı vekilince duruşmalı olarak temyiz edilmekle; kesinlik, süre, temyiz şartı ve diğer usul eksiklikleri yönünden yapılan ön inceleme sonucunda, 24.04.2025 tarihinde duruşma yapılmasına ve duruşma gününün taraflara davetiye ile bildirilmesine karar verilmiştir.

Belli edilen günde asıl ve birleşen davada davacı vekili Avukat ... geldi. Tebligata rağmen başka gelen olmadığı anlaşılmakla duruşmaya başlanarak hazır bulunan avukatın sözlü açıklaması dinlendikten sonra işin incelenerek karara bağlanması için uygun görülen saatte Tetkik Hâkimi tarafından hazırlanan rapor dinlenerek dosyadaki belgeler incelenip gereği düşünüldü:

I. DAVA 
1. Asıl davada davacı vekili dava dilekçesinde; müvekkili arsa sahibi ile yüklenici şirket arasında 6306 sayılı Kentsel Dönüşüm Kanunu kapsamında arsa payı karşılığı inşaat sözleşmesi yapıldığını, müvekkilinin kendisine ait bağımsız bölümü yapılacak inşaattan bağımsız bölümün müvekkiline verilmesi koşuluyla yükleniciye devrettiğini, inşaatın 31 parsel ile 32 parselin birleşmesi sonucu oluşan 33 no.lu parselde yapıldığını ve blok isimlerinin değişmesi sonucu müvekkiline teslim edilmesi gereken bağımsız bölümün A blok 13. numaralı daire olduğunu, taşınmazın müvekkiline fiilen teslim edilmesine rağmen tapuda müvekkil adına tescil ettirilmediğini ileri sürerek arsa payı karşılığı inşaat sözleşmesinin geriye etkili feshi ile A blok, 13 no.lu dairenin tapu kaydının iptali ile takyidatsız müvekkili adına tescilini talep etmiştir.
...
II. CEVAP
1. Asıl davada davalı şirket davanın reddini sitemiştir.
...
d. Müvekkili bankanın TMK’nın 1023. maddesi uyarınca tapu kütüğündeki sicile iyiniyete dayanarak ipotek tesis ettirdiğinden kazanımının korunması gerektiğini,
...
g. Arsa sahibi davacının sözleşmenin başında tapusunu devrettiğini, sözleşme feshedilmediğinden avans olarak yükleniciye devredilen tapu payının arsa sahibine dönmesinin söz konusu olmayacağını, müvekkilinin kötü niyetli olduğunun veya davalı inşaat firmasıyla birlikte hareket ettiğinin ispatlanamadığını beyan etmektedir.

B. Değerlendirme ve Gerekçe
Uyuşmazlık arsa payı karşılığı inşaat sözleşmesinden kaynaklanan tapu iptali ve tescil, ipoteğin kaldırılması istemlerine ilişkindir.
...
28.000,00 TL duruşma vekâlet ücretinin birleşen davada davalıdan alınarak Yargıtaydaki duruşmada vekille temsil olunan davacıya verilmesine, 

Aşağıda yazılı temyiz harcının temyiz eden birleşen davada davalıya yükletilmesine,

Dosyanın İlk Derece Mahkemesine, kararın bir örneğinin Bölge Adliye Mahkemesine gönderilmesine,

24.04.2025 tarihinde oy birliğiyle karar verildi.</div>
    </article>
